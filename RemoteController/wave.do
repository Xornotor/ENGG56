...
add wave -noupdate -divider {Casos de Teste}
...
add wave -noupdate -divider {Data Checking}
add wave -noupdate -label DATA_CHECK -radix hexadecimal /Remote_TB/data_check
add wave -noupdate -label DATA_INV_CHECK -radix hexadecimal /Remote_TB/data_inv_check
add wave -noupdate -label CHECKSUM -radix hexadecimal /Remote_TB/checksum
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1945 us} 0}
...
update
WaveRestoreZoom {1314 us} {2247 us}
